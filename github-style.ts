...
function createTheme(colorPalette: IColorPalette, mode: 'dark' | 'light') {
  ...
  return {
    ...
    "badge.foreground": chroma(palette.accent5).brighten(2).hex(),
    "badge.background": chroma(palette.accent5).brighten(3).hex(),

    "progressBar.background": palette.accent5,
    ...
    "activityBarBadge.background": palette.accent5,
    "activityBar.activeBorder": palette.accent5,
    ...
    "list.inactiveFocusBackground": chroma(palette.accent5).darken(3).hex(),
    "list.focusBackground": chroma(palette.accent5).darken(4).hex(),
    ...
    "notificationsErrorIcon.foreground": chroma(palette.accent0).brighten().hex(),
    "notificationsWarningIcon.foreground": chroma(palette.accent1).brighten(2).hex(),
    "notificationsInfoIcon.foreground": chroma(palette.accent5).brighten(2).hex(),
    ...
    "editorCursor.foreground": chroma(palette.accent5).brighten(3).hex(),

    "editor.findMatchBackground": palette.accent2,
    "editor.findMatchHighlightBackground": chroma(palette.accent2).alpha(.4).hex(),
    "editor.inactiveSelectionBackground": chroma(palette.accent5).brighten(1).alpha(.1).hex(),
    "editor.selectionBackground": chroma(palette.accent5).brighten(1).alpha(.2).hex(),
    ...
    "editor.wordHighlightBorder": chroma(palette.accent3).brighten(2).alpha(.6).hex(),
    "editor.wordHighlightStrongBorder": chroma(palette.accent3).brighten(2).alpha(.3).hex(),
    ...
    "editorGutter.modifiedBackground": palette.accent5,
    "editorGutter.addedBackground": chroma(palette.accent3).brighten().hex(),
    "editorGutter.deletedBackground": chroma(palette.accent0).brighten().hex(),

    "diffEditor.insertedTextBackground": chroma(palette.accent3).alpha(.2).hex(),
    "diffEditor.removedTextBackground": chroma(palette.accent0).brighten(1).alpha(.25).hex(),
    ...
    "panelTitle.activeBorder": chroma(palette.accent1).brighten(2).hex(),                     //"#f9826c",
    ...
    "gitDecoration.addedResourceForeground": chroma(palette.accent3).brighten().hex(),        //colorPalette.green[5],
    "gitDecoration.modifiedResourceForeground": chroma(palette.accent5).brighten(2).hex(),    //colorPalette.blue[6],
    "gitDecoration.deletedResourceForeground": chroma(palette.accent0).brighten().hex(),      // colorPalette.red[5],
    "gitDecoration.untrackedResourceForeground": chroma(palette.accent3).brighten().hex(),    // colorPalette.green[5],
    "gitDecoration.ignoredResourceForeground": palette.shade4,                                //colorPalette.gray[4],
    "gitDecoration.conflictingResourceForeground": chroma(palette.accent1).brighten(2).hex(), //colorPalette.orange[6],
    ...
    "editor.stackFrameHighlightBackground": chroma(palette.accent2).darken(3).hex(),          //pick({ light: colorPalette.yellow[1], dark: "#a707" }),
    "editor.focusedStackFrameHighlightBackground": chroma(palette.accent2).darken(2).hex(),   // pick({ light: colorPalette.yellow[2], dark: "#b808" }),

    "peekViewEditor.matchHighlightBackground":chroma(palette.accent2).darken(2).hex(),        // pick({ dark: "#ffd33d33" }),
    "peekViewResult.matchHighlightBackground":chroma(palette.accent2).darken(2).hex(),        // pick({ dark: "#ffd33d33" }),
